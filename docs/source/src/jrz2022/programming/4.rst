...
1. Among them, under graduate students are required to complete at least 150 credits, and graduate students are required to complete at least 36 credits, and pass both teaching practice and scientific research assessement.

2. The contents of the question include:
...
3. Complete the following classes called :cpp:`Student`, :cpp:`UStudent`, :cpp:`GStudent`, and the :cpp:`main` function, so that the program can create a ``studentGraduate.data`` file as following correctly:
